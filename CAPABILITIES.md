...
- **Baked-in workflow core with additive skills**: teleportation, sovereign scaffold, `.hematite/PLAN.md`, `.hematite/TASK.md`, and resumable execution stay in the harness; `SKILLS.md` and `SKILL.md` are optional project-guidance layers, not replacements for core workflow control
