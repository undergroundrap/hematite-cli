...
- **The Scientific Mandate**: A core identity directive that enforces verifiable computation. Hematite refuses to guess results for math/physics/CS problems, instead using its sandbox to derive proven answers.
