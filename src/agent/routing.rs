...
pub fn preferred_host_inspection_topic(user_input: &str) -> Option<&'static str> {
    ...
    let asks_domain_health = lower.contains("domain health")
        ...
        || (lower.contains("kerberos") && lower.contains("working"))
        || (lower.contains("reach") && lower.contains("the dc"))
        || (lower.contains(" dc") && lower.contains("reach"));
    ...
    let asks_local_security_policy = lower.contains("password policy")
        ...
        || lower.contains("ntlm authentication")
        || (lower.contains("ntlm") && lower.contains("level"))
