...
async fn main() -> Result<(), Box<dyn std::error::Error>> {
    ...
    if let Some(ref query) = cockpit.percent {
        let result = hematite::tools::math_util::percent_calc(query.trim());
        println!("{}", result.trim());
        if cockpit.clipboard {
            copy_to_clipboard(&result);
            println!("Copied to clipboard.");
    ...
    if let Some(ref query) = cockpit.complex {
        let result = hematite::tools::math_util::complex_calc(query.trim());
        println!("{}", result.trim());
        if cockpit.clipboard {
            copy_to_clipboard(&result);
            println!("Copied to clipboard.");
    ...
    if let Some(ref query) = cockpit.nt {
        let result = hematite::tools::math_util::number_theory_calc(query.trim());
        println!("{}", result.trim());
        if cockpit.clipboard {
            copy_to_clipboard(&result);
            println!("Copied to clipboard.");
    ...
    if let Some(ref query) = cockpit.health {
        let result = hematite::tools::math_util::health_calc(query.trim());
        println!("{}", result.trim());
        if cockpit.clipboard {
            copy_to_clipboard(&result);
            println!("Copied to clipboard.");
    ...
    if let Some(ref query) = cockpit.json {
        let result = hematite::tools::math_util::json_calc(query.trim());
        println!("{}", result.trim());
        if cockpit.clipboard {
            copy_to_clipboard(&result);
            println!("Copied to clipboard.");
    ...
    if let Some(ref query) = cockpit.regex {
        let result = hematite::tools::math_util::regex_calc(query.trim());
        println!("{}", result.trim());
        if cockpit.clipboard {
            copy_to_clipboard(&result);
            println!("Copied to clipboard.");
    ...
    if let Some(ref query) = cockpit.csv {
        let result = hematite::tools::math_util::csv_calc(query.trim());
        println!("{}", result.trim());
        if cockpit.clipboard {
            copy_to_clipboard(&result);
            println!("Copied to clipboard.");
    ...
    if let Some(ref query) = cockpit.jwt {
        let result = hematite::tools::math_util::jwt_calc(query.trim());
        println!("{}", result.trim());
        if cockpit.clipboard {
            copy_to_clipboard(&result);
            println!("Copied to clipboard.");
    ...
    if let Some(ref query) = cockpit.url_tool {
        let result = hematite::tools::math_util::url_calc(query.trim());
        println!("{}", result.trim());
        if cockpit.clipboard {
            copy_to_clipboard(&result);
            println!("Copied to clipboard.");
    ...
    if let Some(ref query) = cockpit.cron {
        let result = hematite::tools::math_util::cron_calc(query.trim());
        println!("{}", result.trim());
        if cockpit.clipboard {
            copy_to_clipboard(&result);
            println!("Copied to clipboard.");
    ...
    if let Some(ref query) = cockpit.timestamp {
        let result = hematite::tools::math_util::timestamp_calc(query.trim());
        println!("{}", result.trim());
        if cockpit.clipboard {
            copy_to_clipboard(&result);
            println!("Copied to clipboard.");
    ...
    if let Some(ref query) = cockpit.yaml {
        let result = hematite::tools::math_util::yaml_calc(query.trim());
        println!("{}", result.trim());
        if cockpit.clipboard {
            copy_to_clipboard(&result);
            println!("Copied to clipboard.");
    ...
    if let Some(ref query) = cockpit.table {
        let result = hematite::tools::math_util::table_calc(query.trim());
        println!("{}", result.trim());
        if cockpit.clipboard {
            copy_to_clipboard(&result);
            println!("Copied to clipboard.");
    ...
    if let Some(ref query) = cockpit.sql_fmt {
        let result = hematite::tools::math_util::sql_fmt_calc(query.trim());
        println!("{}", result.trim());
        if cockpit.clipboard {
            copy_to_clipboard(&result);
            println!("Copied to clipboard.");
    ...
    if let Some(ref query) = cockpit.http {
        let result = hematite::tools::math_util::http_calc(query.trim());
        println!("{}", result.trim());
        if cockpit.clipboard {
            copy_to_clipboard(&result);
            println!("Copied to clipboard.");
    ...
    if let Some(ref query) = cockpit.mime {
        let result = hematite::tools::math_util::mime_calc(query.trim());
        println!("{}", result.trim());
        if cockpit.clipboard {
            copy_to_clipboard(&result);
            println!("Copied to clipboard.");
    ...
    if let Some(ref query) = cockpit.xml {
        let result = hematite::tools::math_util::xml_calc(query.trim());
        println!("{}", result.trim());
        if cockpit.clipboard {
            copy_to_clipboard(&result);
            println!("Copied to clipboard.");
    ...
    if let Some(ref query) = cockpit.toml {
        let result = hematite::tools::math_util::toml_calc(query.trim());
        println!("{}", result.trim());
        if cockpit.clipboard {
            copy_to_clipboard(&result);
            println!("Copied to clipboard.");
    ...
    if let Some(ref query) = cockpit.net {
        let result = hematite::tools::math_util::net_calc(query.trim());
        println!("{}", result.trim());
        if cockpit.clipboard {
            copy_to_clipboard(&result);
            println!("Copied to clipboard.");
    ...
    if let Some(ref query) = cockpit.ascii {
        let result = hematite::tools::math_util::ascii_calc(query.trim());
        println!("{}", result.trim());
        if cockpit.clipboard {
            copy_to_clipboard(&result);
            println!("Copied to clipboard.");
    ...
    if let Some(ref query) = cockpit.kbd {
        let result = hematite::tools::math_util::kbd_calc(query.trim());
        println!("{}", result.trim());
        if cockpit.clipboard {
            copy_to_clipboard(&result);
            println!("Copied to clipboard.");
    ...
    if let Some(ref query) = cockpit.duration {
        let result = hematite::tools::math_util::duration_calc(query.trim());
        println!("{}", result.trim());
        if cockpit.clipboard {
            copy_to_clipboard(&result);
            println!("Copied to clipboard.");
    ...
    if let Some(ref query) = cockpit.spark {
        let result = hematite::tools::math_util::spark_calc(query.trim());
        println!("{}", result.trim());
        if cockpit.clipboard {
            copy_to_clipboard(&result);
            println!("Copied to clipboard.");
    ...
    if let Some(ref query) = cockpit.template {
        let result = hematite::tools::math_util::template_calc(query.trim());
        println!("{}", result.trim());
        if cockpit.clipboard {
            copy_to_clipboard(&result);
            println!("Copied to clipboard.");
    ...
    if let Some(ref query) = cockpit.escape {
        let result = hematite::tools::math_util::escape_calc(query.trim());
        println!("{}", result.trim());
        if cockpit.clipboard {
            copy_to_clipboard(&result);
            println!("Copied to clipboard.");
    ...
    if let Some(ref query) = cockpit.port {
        let result = hematite::tools::math_util::port_calc(query.trim());
        println!("{}", result.trim());
        if cockpit.clipboard {
            copy_to_clipboard(&result);
            println!("Copied to clipboard.");
    ...
    if let Some(ref query) = cockpit.chars {
        let result = hematite::tools::math_util::chars_calc(query.trim());
        println!("{}", result.trim());
        if cockpit.clipboard {
            copy_to_clipboard(&result);
            println!("Copied to clipboard.");
    ...
    if let Some(ref query) = cockpit.tz {
        let result = hematite::tools::math_util::tz_calc(query.trim());
        println!("{}", result.trim());
        if cockpit.clipboard {
            copy_to_clipboard(&result);
            println!("Copied to clipboard.");
    ...
    if let Some(ref query) = cockpit.headers {
        let result = hematite::tools::math_util::headers_calc(query.trim());
        println!("{}", result.trim());
        if cockpit.clipboard {
            copy_to_clipboard(&result);
            println!("Copied to clipboard.");
    ...
    if let Some(ref query) = cockpit.gitignore {
        let result = hematite::tools::math_util::gitignore_calc(query.trim());
        print!("{result}");
        if cockpit.clipboard {
            copy_to_clipboard(&result);
            println!("Copied to clipboard.");
    ...
    if let Some(ref query) = cockpit.license {
        let result = hematite::tools::math_util::license_calc(query.trim());
        println!("{}", result.trim());
        if cockpit.clipboard {
            copy_to_clipboard(&result);
            println!("Copied to clipboard.");
    ...
    if let Some(ref query) = cockpit.json_path {
        let result = hematite::tools::math_util::json_path_calc(query.trim());
        println!("{}", result.trim());
        if cockpit.clipboard {
            copy_to_clipboard(&result);
            println!("Copied to clipboard.");
    ...
    if let Some(ref query) = cockpit.markdown {
        let result = hematite::tools::math_util::markdown_calc(query.trim());
        println!("{}", result.trim());
        if cockpit.clipboard {
            copy_to_clipboard(&result);
            println!("Copied to clipboard.");
    ...
    if let Some(ref query) = cockpit.regex_ref {
        let result = hematite::tools::math_util::regex_ref_calc(query.trim());
        println!("{}", result.trim());
        if cockpit.clipboard {
            copy_to_clipboard(&result);
            println!("Copied to clipboard.");
    ...
    if let Some(ref query) = cockpit.ascii_table {
        let result = hematite::tools::math_util::ascii_table_calc(query.trim());
        println!("{}", result.trim());
        if cockpit.clipboard {
            copy_to_clipboard(&result);
            println!("Copied to clipboard.");
    ...
    if let Some(ref query) = cockpit.ssl {
        let result = hematite::tools::math_util::ssl_calc(query.trim());
        println!("{}", result.trim());
        if cockpit.clipboard {
            copy_to_clipboard(&result);
            println!("Copied to clipboard.");
    ...
    if let Some(ref query) = cockpit.id {
        let result = hematite::tools::math_util::id_gen_calc(query.trim());
        println!("{}", result.trim());
        if cockpit.clipboard {
            copy_to_clipboard(&result);
            println!("Copied to clipboard.");
    ...
    if let Some(ref query) = cockpit.http_status {
        let result = hematite::tools::math_util::http_status_calc(query.trim());
        println!("{}", result.trim());
        if cockpit.clipboard {
            copy_to_clipboard(&result);
            println!("Copied to clipboard.");
    ...
    if let Some(ref query) = cockpit.git_ref {
        let result = hematite::tools::math_util::git_ref_calc(query.trim());
        println!("{}", result.trim());
        if cockpit.clipboard {
            copy_to_clipboard(&result);
            println!("Copied to clipboard.");
    ...
    if let Some(ref query) = cockpit.color_names {
        let result = hematite::tools::math_util::color_names_calc(query.trim());
        println!("{}", result.trim());
        if cockpit.clipboard {
            copy_to_clipboard(&result);
            println!("Copied to clipboard.");
    ...
    if let Some(ref query) = cockpit.docker_ref {
        let result = hematite::tools::math_util::docker_ref_calc(query.trim());
        println!("{}", result.trim());
        if cockpit.clipboard {
            copy_to_clipboard(&result);
            println!("Copied to clipboard.");
    ...
    if let Some(ref query) = cockpit.sql_ref {
        let result = hematite::tools::math_util::sql_ref_calc(query.trim());
        println!("{}", result.trim());
        if cockpit.clipboard {
            copy_to_clipboard(&result);
            println!("Copied to clipboard.");
    ...
    if let Some(ref query) = cockpit.vim {
        let result = hematite::tools::math_util::vim_calc(query.trim());
        println!("{}", result.trim());
        if cockpit.clipboard {
            copy_to_clipboard(&result);
            println!("Copied to clipboard.");
    ...
    if let Some(ref query) = cockpit.curl {
        let result = hematite::tools::math_util::curl_calc(query.trim());
        println!("{}", result.trim());
        if cockpit.clipboard {
            copy_to_clipboard(&result);
            println!("Copied to clipboard.");
    ...
    if let Some(ref query) = cockpit.jq {
        let result = hematite::tools::math_util::jq_calc(query.trim());
        println!("{}", result.trim());
        if cockpit.clipboard {
            copy_to_clipboard(&result);
            println!("Copied to clipboard.");
    ...
    if let Some(ref query) = cockpit.grep {
        let result = hematite::tools::math_util::grep_calc(query.trim());
        println!("{}", result.trim());
        if cockpit.clipboard {
            copy_to_clipboard(&result);
            println!("Copied to clipboard.");
    ...
    if let Some(ref query) = cockpit.sed {
        let result = hematite::tools::math_util::sed_calc(query.trim());
        println!("{}", result.trim());
        if cockpit.clipboard {
            copy_to_clipboard(&result);
            println!("Copied to clipboard.");
    ...
    if let Some(ref query) = cockpit.awk {
        let result = hematite::tools::math_util::awk_calc(query.trim());
        println!("{}", result.trim());
        if cockpit.clipboard {
            copy_to_clipboard(&result);
            println!("Copied to clipboard.");
    ...
    if let Some(ref query) = cockpit.ssh_ref {
        let result = hematite::tools::math_util::ssh_ref_calc(query.trim());
        println!("{}", result.trim());
        if cockpit.clipboard {
            copy_to_clipboard(&result);
            println!("Copied to clipboard.");
    ...
    if let Some(ref query) = cockpit.tar {
        let result = hematite::tools::math_util::tar_calc(query.trim());
        println!("{}", result.trim());
        if cockpit.clipboard {
            copy_to_clipboard(&result);
            println!("Copied to clipboard.");
    ...
    if let Some(ref query) = cockpit.find {
        let result = hematite::tools::math_util::find_calc(query.trim());
        println!("{}", result.trim());
        if cockpit.clipboard {
            copy_to_clipboard(&result);
            println!("Copied to clipboard.");
    ...
    if let Some(ref query) = cockpit.systemd {
        let result = hematite::tools::math_util::systemd_calc(query.trim());
        println!("{}", result.trim());
        if cockpit.clipboard {
            copy_to_clipboard(&result);
            println!("Copied to clipboard.");
    ...
    if let Some(ref query) = cockpit.make {
        let result = hematite::tools::math_util::make_calc(query.trim());
        println!("{}", result.trim());
        if cockpit.clipboard {
            copy_to_clipboard(&result);
            println!("Copied to clipboard.");
    ...
    if let Some(ref query) = cockpit.chmod {
        let result = hematite::tools::math_util::chmod_calc(query.trim());
        println!("{}", result.trim());
        if cockpit.clipboard {
            copy_to_clipboard(&result);
            println!("Copied to clipboard.");
    ...
    if let Some(ref query) = cockpit.openssl {
        let result = hematite::tools::math_util::openssl_calc(query.trim());
        println!("{}", result.trim());
        if cockpit.clipboard {
            copy_to_clipboard(&result);
            println!("Copied to clipboard.");
    ...
    if let Some(ref query) = cockpit.nginx {
        let result = hematite::tools::math_util::nginx_calc(query.trim());
        println!("{}", result.trim());
        if cockpit.clipboard {
            copy_to_clipboard(&result);
            println!("Copied to clipboard.");
    ...
    if let Some(ref query) = cockpit.bash_ref {
        let result = hematite::tools::math_util::bash_ref_calc(query.trim());
        println!("{}", result.trim());
        if cockpit.clipboard {
            copy_to_clipboard(&result);
            println!("Copied to clipboard.");
    ...
    if let Some(ref query) = cockpit.python_ref {
        let result = hematite::tools::math_util::python_ref_calc(query.trim());
        println!("{}", result.trim());
        if cockpit.clipboard {
            copy_to_clipboard(&result);
            println!("Copied to clipboard.");
    ...
    if let Some(ref query) = cockpit.rust_ref {
        let result = hematite::tools::math_util::rust_ref_calc(query.trim());
        println!("{}", result.trim());
        if cockpit.clipboard {
            copy_to_clipboard(&result);
            println!("Copied to clipboard.");
    ...
    if let Some(ref query) = cockpit.go_ref {
        let result = hematite::tools::math_util::go_ref_calc(query.trim());
        println!("{}", result.trim());
        if cockpit.clipboard {
            copy_to_clipboard(&result);
            println!("Copied to clipboard.");
    ...
    if let Some(ref query) = cockpit.js_ref {
        let result = hematite::tools::math_util::js_ref_calc(query.trim());
        println!("{}", result.trim());
        if cockpit.clipboard {
            copy_to_clipboard(&result);
            println!("Copied to clipboard.");
    ...
    if let Some(ref query) = cockpit.kubectl {
        let result = hematite::tools::math_util::kubectl_calc(query.trim());
        println!("{}", result.trim());
        if cockpit.clipboard {
            copy_to_clipboard(&result);
            println!("Copied to clipboard.");
    ...
    if let Some(ref query) = cockpit.tmux {
        let result = hematite::tools::math_util::tmux_calc(query.trim());
        println!("{}", result.trim());
        if cockpit.clipboard {
            copy_to_clipboard(&result);
            println!("Copied to clipboard.");
    ...
    if let Some(ref query) = cockpit.postgres {
        let result = hematite::tools::math_util::postgres_calc(query.trim());
        println!("{}", result.trim());
        if cockpit.clipboard {
            copy_to_clipboard(&result);
            println!("Copied to clipboard.");
    ...
    if let Some(ref query) = cockpit.ts_ref {
        let result = hematite::tools::math_util::ts_ref_calc(query.trim());
        println!("{}", result.trim());
        if cockpit.clipboard {
            copy_to_clipboard(&result);
            println!("Copied to clipboard.");
    ...
    if let Some(ref query) = cockpit.ansible {
        let result = hematite::tools::math_util::ansible_calc(query.trim());
        println!("{}", result.trim());
        if cockpit.clipboard {
            copy_to_clipboard(&result);
            println!("Copied to clipboard.");
    ...
    if let Some(ref query) = cockpit.terraform {
        let result = hematite::tools::math_util::terraform_calc(query.trim());
        println!("{}", result.trim());
        if cockpit.clipboard {
            copy_to_clipboard(&result);
            println!("Copied to clipboard.");
    ...
    if let Some(ref query) = cockpit.npm {
        let result = hematite::tools::math_util::npm_calc(query.trim());
        println!("{}", result.trim());
        if cockpit.clipboard {
            copy_to_clipboard(&result);
            println!("Copied to clipboard.");
    ...
    if let Some(ref query) = cockpit.git_adv {
        let result = hematite::tools::math_util::git_adv_calc(query.trim());
        println!("{}", result.trim());
        if cockpit.clipboard {
            copy_to_clipboard(&result);
            println!("Copied to clipboard.");
    ...
    if let Some(ref query) = cockpit.docker_adv {
        let result = hematite::tools::math_util::docker_adv_calc(query.trim());
        println!("{}", result.trim());
        if cockpit.clipboard {
            copy_to_clipboard(&result);
            println!("Copied to clipboard.");
    ...
    if let Some(ref query) = cockpit.systemd_adv {
        let result = hematite::tools::math_util::systemd_adv_calc(query.trim());
        println!("{}", result.trim());
        if cockpit.clipboard {
            copy_to_clipboard(&result);
            println!("Copied to clipboard.");
    ...
    if let Some(ref query) = cockpit.makefile {
        let result = hematite::tools::math_util::makefile_calc(query.trim());
        println!("{}", result.trim());
        if cockpit.clipboard {
            copy_to_clipboard(&result);
            println!("Copied to clipboard.");
    ...
    if let Some(ref query) = cockpit.jinja {
        let result = hematite::tools::math_util::jinja_calc(query.trim());
        println!("{}", result.trim());
        if cockpit.clipboard {
            copy_to_clipboard(&result);
            println!("Copied to clipboard.");
    ...
    if let Some(ref query) = cockpit.http_adv {
        let result = hematite::tools::math_util::http_adv_calc(query.trim());
        println!("{}", result.trim());
        if cockpit.clipboard {
            copy_to_clipboard(&result);
            println!("Copied to clipboard.");
    ...
    if let Some(ref query) = cockpit.linux_adv {
        let result = hematite::tools::math_util::linux_adv_calc(query.trim());
        println!("{}", result.trim());
        if cockpit.clipboard {
            copy_to_clipboard(&result);
            println!("Copied to clipboard.");
    ...
    if let Some(ref query) = cockpit.security_ref {
        let result = hematite::tools::math_util::security_ref_calc(query.trim());
        println!("{}", result.trim());
        if cockpit.clipboard {
            copy_to_clipboard(&result);
            println!("Copied to clipboard.");
    ...
    if let Some(ref query) = cockpit.cloud_ref {
        let result = hematite::tools::math_util::cloud_ref_calc(query.trim());
        println!("{}", result.trim());
        if cockpit.clipboard {
            copy_to_clipboard(&result);
            println!("Copied to clipboard.");
    ...
    if let Some(ref query) = cockpit.regex_adv {
        let result = hematite::tools::math_util::regex_adv_calc(query.trim());
        println!("{}", result.trim());
        if cockpit.clipboard {
            copy_to_clipboard(&result);
            println!("Copied to clipboard.");
    ...
    if let Some(ref query) = cockpit.sql_adv {
        let result = hematite::tools::math_util::sql_adv_calc(query.trim());
        println!("{}", result.trim());
        if cockpit.clipboard {
            copy_to_clipboard(&result);
            println!("Copied to clipboard.");
    ...
    if let Some(ref query) = cockpit.vim_adv {
        let result = hematite::tools::math_util::vim_adv_calc(query.trim());
        println!("{}", result.trim());
        if cockpit.clipboard {
            copy_to_clipboard(&result);
            println!("Copied to clipboard.");
    ...
    if let Some(ref query) = cockpit.python_data {
        let result = hematite::tools::math_util::python_data_calc(query.trim());
        println!("{}", result.trim());
        if cockpit.clipboard {
            copy_to_clipboard(&result);
            println!("Copied to clipboard.");
    ...
    if let Some(ref query) = cockpit.css_ref {
        let result = hematite::tools::math_util::css_ref_calc(query.trim());
        println!("{}", result.trim());
        if cockpit.clipboard {
            copy_to_clipboard(&result);
            println!("Copied to clipboard.");
    ...
    if let Some(ref query) = cockpit.rust_adv {
        let result = hematite::tools::math_util::rust_adv_calc(query.trim());
        println!("{}", result.trim());
        if cockpit.clipboard {
            copy_to_clipboard(&result);
            println!("Copied to clipboard.");
    ...
    if let Some(ref query) = cockpit.algo_ref {
        let result = hematite::tools::math_util::algo_ref_calc(query.trim());
        println!("{}", result.trim());
        if cockpit.clipboard {
            copy_to_clipboard(&result);
            println!("Copied to clipboard.");
    ...
    if let Some(ref query) = cockpit.oop_ref {
        let result = hematite::tools::math_util::oop_ref_calc(query.trim());
        println!("{}", result.trim());
        if cockpit.clipboard {
            copy_to_clipboard(&result);
            println!("Copied to clipboard.");
    ...
    if let Some(ref query) = cockpit.typescript_adv {
        let result = hematite::tools::math_util::typescript_adv_calc(query.trim());
        println!("{}", result.trim());
        if cockpit.clipboard {
            copy_to_clipboard(&result);
            println!("Copied to clipboard.");
    ...
    if let Some(ref query) = cockpit.bash_adv {
        let result = hematite::tools::math_util::bash_adv_calc(query.trim());
        println!("{}", result.trim());
        if cockpit.clipboard {
            copy_to_clipboard(&result);
            println!("Copied to clipboard.");
    ...
    if let Some(ref query) = cockpit.network_ref {
        let result = hematite::tools::math_util::network_ref_calc(query.trim());
        println!("{}", result.trim());
        if cockpit.clipboard {
            copy_to_clipboard(&result);
            println!("Copied to clipboard.");
    ...
    if let Some(ref query) = cockpit.unicode_ref {
        let result = hematite::tools::math_util::unicode_ref_calc(query.trim());
        println!("{}", result.trim());
        if cockpit.clipboard {
            copy_to_clipboard(&result);
            println!("Copied to clipboard.");
    ...
    if let Some(ref query) = cockpit.regex_tester {
        let result = hematite::tools::math_util::regex_test_calc(query.trim());
        println!("{}", result.trim());
        if cockpit.clipboard {
            copy_to_clipboard(&result);
            println!("Copied to clipboard.");
    ...
    if let Some(ref query) = cockpit.http_headers {
        let result = hematite::tools::math_util::http_headers_calc(query.trim());
        println!("{}", result.trim());
        if cockpit.clipboard {
            copy_to_clipboard(&result);
            println!("Copied to clipboard.");
    ...
    if let Some(ref query) = cockpit.crypto_ref {
        let result = hematite::tools::math_util::crypto_ref_calc(query.trim());
        println!("{}", result.trim());
        if cockpit.clipboard {
            copy_to_clipboard(&result);
            println!("Copied to clipboard.");
    ...
    if let Some(ref query) = cockpit.devops_ref {
        let result = hematite::tools::math_util::devops_ref_calc(query.trim());
        println!("{}", result.trim());
        if cockpit.clipboard {
            copy_to_clipboard(&result);
            println!("Copied to clipboard.");
    ...
    if let Some(ref query) = cockpit.linux_sys {
        let result = hematite::tools::math_util::linux_sys_calc(query.trim());
        println!("{}", result.trim());
        if cockpit.clipboard {
            copy_to_clipboard(&result);
            println!("Copied to clipboard.");
    ...
    if let Some(ref query) = cockpit.api_design {
        let result = hematite::tools::math_util::api_design_calc(query.trim());
        println!("{}", result.trim());
        if cockpit.clipboard {
            copy_to_clipboard(&result);
            println!("Copied to clipboard.");
    ...
    if let Some(ref query) = cockpit.db_design {
        let result = hematite::tools::math_util::db_design_calc(query.trim());
        println!("{}", result.trim());
        if cockpit.clipboard {
            copy_to_clipboard(&result);
            println!("Copied to clipboard.");
    ...
    if let Some(ref query) = cockpit.k8s_ref {
        let result = hematite::tools::math_util::k8s_ref_calc(query.trim());
        println!("{}", result.trim());
        if cockpit.clipboard {
            copy_to_clipboard(&result);
            println!("Copied to clipboard.");
    ...
    if let Some(ref query) = cockpit.observability {
        let result = hematite::tools::math_util::observability_calc(query.trim());
        println!("{}", result.trim());
        if cockpit.clipboard {
            copy_to_clipboard(&result);
            println!("Copied to clipboard.");
    ...
    if let Some(ref query) = cockpit.terraform_adv {
        let result = hematite::tools::math_util::terraform_adv_calc(query.trim());
        println!("{}", result.trim());
        if cockpit.clipboard {
            copy_to_clipboard(&result);
            println!("Copied to clipboard.");
    ...
    if let Some(ref query) = cockpit.security_scan {
        let result = hematite::tools::math_util::security_scan_calc(query.trim());
        println!("{}", result.trim());
        if cockpit.clipboard {
            copy_to_clipboard(&result);
            println!("Copied to clipboard.");
    ...
    if let Some(ref query) = cockpit.ml_ref {
        let result = hematite::tools::math_util::ml_ref_calc(query.trim());
        println!("{}", result.trim());
        if cockpit.clipboard {
            copy_to_clipboard(&result);
            println!("Copied to clipboard.");
    ...
    if let Some(ref query) = cockpit.rust_patterns {
        let result = hematite::tools::math_util::rust_patterns_calc(query.trim());
        println!("{}", result.trim());
        if cockpit.clipboard {
            copy_to_clipboard(&result);
            println!("Copied to clipboard.");
    ...
    if let Some(ref query) = cockpit.event_driven {
        let result = hematite::tools::math_util::event_driven_calc(query.trim());
        println!("{}", result.trim());
        if cockpit.clipboard {
            copy_to_clipboard(&result);
            println!("Copied to clipboard.");
    ...
    if let Some(ref query) = cockpit.api_gateway {
        let result = hematite::tools::math_util::api_gateway_calc(query.trim());
        println!("{}", result.trim());
        if cockpit.clipboard {
            copy_to_clipboard(&result);
            println!("Copied to clipboard.");
    ...
    if let Some(ref query) = cockpit.cicd_ref {
        let result = hematite::tools::math_util::cicd_ref_calc(query.trim());
        println!("{}", result.trim());
        if cockpit.clipboard {
            copy_to_clipboard(&result);
            println!("Copied to clipboard.");
    ...
    if let Some(ref query) = cockpit.design_patterns {
        let result = hematite::tools::math_util::design_patterns_calc(query.trim());
        println!("{}", result.trim());
        if cockpit.clipboard {
            copy_to_clipboard(&result);
            println!("Copied to clipboard.");
    ...
    if let Some(ref query) = cockpit.auth_ref {
        let result = hematite::tools::math_util::auth_ref_calc(query.trim());
        println!("{}", result.trim());
        if cockpit.clipboard {
            copy_to_clipboard(&result);
            println!("Copied to clipboard.");
    ...
    if let Some(ref query) = cockpit.linux_kernel {
        let result = hematite::tools::math_util::linux_kernel_calc(query.trim());
        println!("{}", result.trim());
        if cockpit.clipboard {
            copy_to_clipboard(&result);
            println!("Copied to clipboard.");
    ...
    if let Some(ref query) = cockpit.database_adv {
        let result = hematite::tools::math_util::database_adv_calc(query.trim());
        println!("{}", result.trim());
        if cockpit.clipboard {
            copy_to_clipboard(&result);
            println!("Copied to clipboard.");
    ...
    if let Some(ref query) = cockpit.networking_adv {
        let result = hematite::tools::math_util::networking_adv_calc(query.trim());
        println!("{}", result.trim());
        if cockpit.clipboard {
            copy_to_clipboard(&result);
            println!("Copied to clipboard.");
    ...
    if let Some(ref query) = cockpit.testing_ref {
        let result = hematite::tools::math_util::testing_ref_calc(query.trim());
        println!("{}", result.trim());
        if cockpit.clipboard {
            copy_to_clipboard(&result);
            println!("Copied to clipboard.");
    ...
    if let Some(ref query) = cockpit.compiler_ref {
        let result = hematite::tools::math_util::compiler_ref_calc(query.trim());
        println!("{}", result.trim());
        if cockpit.clipboard {
            copy_to_clipboard(&result);
            println!("Copied to clipboard.");
    ...
    if let Some(ref query) = cockpit.monitoring_ref {
        let result = hematite::tools::math_util::monitoring_ref_calc(query.trim());
        println!("{}", result.trim());
        if cockpit.clipboard {
            copy_to_clipboard(&result);
            println!("Copied to clipboard.");
    ...
    if let Some(ref query) = cockpit.search_ref {
        let result = hematite::tools::math_util::search_ref_calc(query.trim());
        println!("{}", result.trim());
        if cockpit.clipboard {
            copy_to_clipboard(&result);
            println!("Copied to clipboard.");
    ...
    if let Some(ref query) = cockpit.protocols_ref {
        let result = hematite::tools::math_util::protocols_ref_calc(query.trim());
        println!("{}", result.trim());
        if cockpit.clipboard {
            copy_to_clipboard(&result);
            println!("Copied to clipboard.");
    ...
    if let Some(ref query) = cockpit.container_ref {
        let result = hematite::tools::math_util::container_ref_calc(query.trim());
        println!("{}", result.trim());
        if cockpit.clipboard {
            copy_to_clipboard(&result);
            println!("Copied to clipboard.");
    ...
    if let Some(ref query) = cockpit.regex_engine {
        let result = hematite::tools::math_util::regex_engine_calc(query.trim());
        println!("{}", result.trim());
        if cockpit.clipboard {
            copy_to_clipboard(&result);
            println!("Copied to clipboard.");
    ...
    if let Some(ref query) = cockpit.git_internals {
        let result = hematite::tools::math_util::git_internals_calc(query.trim());
        println!("{}", result.trim());
        if cockpit.clipboard {
            copy_to_clipboard(&result);
            println!("Copied to clipboard.");
    ...
    if let Some(ref query) = cockpit.data_formats {
        let result = hematite::tools::math_util::data_formats_calc(query.trim());
        println!("{}", result.trim());
        if cockpit.clipboard {
            copy_to_clipboard(&result);
            println!("Copied to clipboard.");
    ...
    if let Some(ref query) = cockpit.regex_patterns {
        let result = hematite::tools::math_util::regex_patterns_calc(query.trim());
        println!("{}", result.trim());
        if cockpit.clipboard {
            copy_to_clipboard(&result);
            println!("Copied to clipboard.");
    ...
    if let Some(ref query) = cockpit.http_security {
        let result = hematite::tools::math_util::http_security_calc(query.trim());
        println!("{}", result.trim());
        if cockpit.clipboard {
            copy_to_clipboard(&result);
            println!("Copied to clipboard.");
    ...
    if let Some(ref query) = cockpit.grpc_ref {
        let result = hematite::tools::math_util::grpc_ref_calc(query.trim());
        println!("{}", result.trim());
        if cockpit.clipboard {
            copy_to_clipboard(&result);
            println!("Copied to clipboard.");
    ...
    if let Some(ref query) = cockpit.wasm_runtime {
        let result = hematite::tools::math_util::wasm_runtime_calc(query.trim());
        println!("{}", result.trim());
        if cockpit.clipboard {
            copy_to_clipboard(&result);
            println!("Copied to clipboard.");
    ...
    if let Some(ref query) = cockpit.linux_perf {
        let result = hematite::tools::math_util::linux_perf_calc(query.trim());
        println!("{}", result.trim());
        if cockpit.clipboard {
            copy_to_clipboard(&result);
            println!("Copied to clipboard.");
    ...
    if let Some(ref query) = cockpit.db_migrations {
        let result = hematite::tools::math_util::db_migrations_calc(query.trim());
        println!("{}", result.trim());
        if cockpit.clipboard {
            copy_to_clipboard(&result);
            println!("Copied to clipboard.");
    ...
    if let Some(ref query) = cockpit.oauth_ref {
        let result = hematite::tools::math_util::oauth_ref_calc(query.trim());
        println!("{}", result.trim());
        if cockpit.clipboard {
            copy_to_clipboard(&result);
            println!("Copied to clipboard.");
    ...
    if let Some(ref query) = cockpit.k8s_security {
        let result = hematite::tools::math_util::k8s_security_calc(query.trim());
        println!("{}", result.trim());
        if cockpit.clipboard {
            copy_to_clipboard(&result);
            println!("Copied to clipboard.");
    ...
    if let Some(ref query) = cockpit.api_versioning {
        let result = hematite::tools::math_util::api_versioning_calc(query.trim());
        println!("{}", result.trim());
        if cockpit.clipboard {
            copy_to_clipboard(&result);
            println!("Copied to clipboard.");
    ...
    if let Some(ref query) = cockpit.message_queue {
        let result = hematite::tools::math_util::message_queue_calc(query.trim());
        println!("{}", result.trim());
        if cockpit.clipboard {
            copy_to_clipboard(&result);
            println!("Copied to clipboard.");
    ...
    if let Some(ref query) = cockpit.caching_ref {
        let result = hematite::tools::math_util::caching_ref_calc(query.trim());
        println!("{}", result.trim());
        if cockpit.clipboard {
            copy_to_clipboard(&result);
            println!("Copied to clipboard.");
    ...
    if let Some(ref query) = cockpit.load_testing {
        let result = hematite::tools::math_util::load_testing_calc(query.trim());
        println!("{}", result.trim());
        if cockpit.clipboard {
            copy_to_clipboard(&result);
            println!("Copied to clipboard.");
    ...
    if let Some(ref query) = cockpit.service_mesh {
        let result = hematite::tools::math_util::service_mesh_calc(query.trim());
        println!("{}", result.trim());
        if cockpit.clipboard {
            copy_to_clipboard(&result);
            println!("Copied to clipboard.");
    ...
    if let Some(ref query) = cockpit.observability_adv {
        let result = hematite::tools::math_util::observability_adv_calc(query.trim());
        println!("{}", result.trim());
        if cockpit.clipboard {
            copy_to_clipboard(&result);
            println!("Copied to clipboard.");
    ...
    if let Some(ref query) = cockpit.terminal_tools {
        let result = hematite::tools::math_util::terminal_tools_calc(query.trim());
        println!("{}", result.trim());
        if cockpit.clipboard {
            copy_to_clipboard(&result);
            println!("Copied to clipboard.");
    ...
    if let Some(ref query) = cockpit.data_pipeline {
        let result = hematite::tools::math_util::data_pipeline_calc(query.trim());
        println!("{}", result.trim());
        if cockpit.clipboard {
            copy_to_clipboard(&result);
            println!("Copied to clipboard.");
    ...
    if let Some(ref query) = cockpit.security_tools {
        let result = hematite::tools::math_util::security_tools_calc(query.trim());
        println!("{}", result.trim());
        if cockpit.clipboard {
            copy_to_clipboard(&result);
            println!("Copied to clipboard.");
    ...
    if let Some(ref query) = cockpit.crypto_adv {
        let result = hematite::tools::math_util::crypto_adv_calc(query.trim());
        println!("{}", result.trim());
        if cockpit.clipboard {
            copy_to_clipboard(&result);
            println!("Copied to clipboard.");
    ...
    if let Some(ref query) = cockpit.browser_dev {
        let result = hematite::tools::math_util::browser_dev_calc(query.trim());
        println!("{}", result.trim());
        if cockpit.clipboard {
            copy_to_clipboard(&result);
            println!("Copied to clipboard.");
    ...
    if let Some(ref query) = cockpit.rust_async {
        let result = hematite::tools::math_util::rust_async_calc(query.trim());
        println!("{}", result.trim());
        if cockpit.clipboard {
            copy_to_clipboard(&result);
            println!("Copied to clipboard.");
    ...
    if let Some(ref query) = cockpit.regex_viz {
        let result = hematite::tools::math_util::regex_viz_calc(query.trim());
        println!("{}", result.trim());
        if cockpit.clipboard {
            copy_to_clipboard(&result);
            println!("Copied to clipboard.");
    ...
    if let Some(ref query) = cockpit.sql_window {
        let result = hematite::tools::math_util::sql_window_calc(query.trim());
        println!("{}", result.trim());
        if cockpit.clipboard {
            copy_to_clipboard(&result);
            println!("Copied to clipboard.");
    ...
    if let Some(ref query) = cockpit.css_grid {
        let result = hematite::tools::math_util::css_grid_calc(query.trim());
        println!("{}", result.trim());
        if cockpit.clipboard {
            copy_to_clipboard(&result);
            println!("Copied to clipboard.");
    ...
    if let Some(ref query) = cockpit.cloud_cost {
        let result = hematite::tools::math_util::cloud_cost_calc(query.trim());
        println!("{}", result.trim());
        if cockpit.clipboard {
            copy_to_clipboard(&result);
            println!("Copied to clipboard.");
    ...
    if let Some(ref query) = cockpit.http2 {
        let result = hematite::tools::math_util::http2_calc(query.trim());
        println!("{}", result.trim());
        if cockpit.clipboard {
            copy_to_clipboard(&result);
            println!("Copied to clipboard.");
    ...
    if let Some(ref query) = cockpit.oauth2_flow {
        let result = hematite::tools::math_util::oauth2_flow_calc(query.trim());
        println!("{}", result.trim());
        if cockpit.clipboard {
            copy_to_clipboard(&result);
            println!("Copied to clipboard.");
    ...
    if let Some(ref query) = cockpit.linux_net {
        let result = hematite::tools::math_util::linux_net_calc(query.trim());
        println!("{}", result.trim());
        if cockpit.clipboard {
            copy_to_clipboard(&result);
            println!("Copied to clipboard.");
    ...
    if let Some(ref query) = cockpit.prom_ref {
        let result = hematite::tools::math_util::prom_ref_calc(query.trim());
        println!("{}", result.trim());
        if cockpit.clipboard {
            copy_to_clipboard(&result);
            println!("Copied to clipboard.");
    ...
    if let Some(ref query) = cockpit.k8s_adv {
        let result = hematite::tools::math_util::k8s_adv_calc(query.trim());
        println!("{}", result.trim());
        if cockpit.clipboard {
            copy_to_clipboard(&result);
            println!("Copied to clipboard.");
    ...
    if let Some(ref query) = cockpit.rust_macros {
        let result = hematite::tools::math_util::rust_macros_calc(query.trim());
        println!("{}", result.trim());
        if cockpit.clipboard {
            copy_to_clipboard(&result);
            println!("Copied to clipboard.");
    ...
    if let Some(ref query) = cockpit.db_internals {
        let result = hematite::tools::math_util::db_internals_calc(query.trim());
        println!("{}", result.trim());
        if cockpit.clipboard {
            copy_to_clipboard(&result);
            println!("Copied to clipboard.");
    ...
    if let Some(ref query) = cockpit.openapi_ref {
        let result = hematite::tools::math_util::openapi_ref_calc(query.trim());
        println!("{}", result.trim());
        if cockpit.clipboard {
            copy_to_clipboard(&result);
            println!("Copied to clipboard.");
    ...
    if let Some(ref query) = cockpit.graphql {
        let result = hematite::tools::math_util::graphql_ref_calc(query.trim());
        println!("{}", result.trim());
        if cockpit.clipboard {
            copy_to_clipboard(&result);
            println!("Copied to clipboard.");
    ...
    if let Some(ref query) = cockpit.react_ref {
        let result = hematite::tools::math_util::react_ref_calc(query.trim());
        println!("{}", result.trim());
        if cockpit.clipboard {
            copy_to_clipboard(&result);
            println!("Copied to clipboard.");
    ...
    if let Some(ref query) = cockpit.node_ref {
        let result = hematite::tools::math_util::node_ref_calc(query.trim());
        println!("{}", result.trim());
        if cockpit.clipboard {
            copy_to_clipboard(&result);
            println!("Copied to clipboard.");
    ...
    if let Some(ref query) = cockpit.java_ref {
        let result = hematite::tools::math_util::java_ref_calc(query.trim());
        println!("{}", result.trim());
        if cockpit.clipboard {
            copy_to_clipboard(&result);
            println!("Copied to clipboard.");
    ...
    if let Some(ref query) = cockpit.python_adv {
        let result = hematite::tools::math_util::python_adv_calc(query.trim());
        println!("{}", result.trim());
        if cockpit.clipboard {
            copy_to_clipboard(&result);
            println!("Copied to clipboard.");
    ...
    if let Some(ref query) = cockpit.go_adv {
        let result = hematite::tools::math_util::go_adv_calc(query.trim());
        println!("{}", result.trim());
        if cockpit.clipboard {
            copy_to_clipboard(&result);
            println!("Copied to clipboard.");
    ...
    if let Some(ref query) = cockpit.vue_ref {
        let result = hematite::tools::math_util::vue_ref_calc(query.trim());
        println!("{}", result.trim());
        if cockpit.clipboard {
            copy_to_clipboard(&result);
            println!("Copied to clipboard.");
    ...
    if let Some(ref query) = cockpit.aws_ref {
        let result = hematite::tools::math_util::aws_ref_calc(query.trim());
        println!("{}", result.trim());
        if cockpit.clipboard {
            copy_to_clipboard(&result);
            println!("Copied to clipboard.");
    ...
    if let Some(ref query) = cockpit.helm_ref {
        let result = hematite::tools::math_util::helm_ref_calc(query.trim());
        println!("{}", result.trim());
        if cockpit.clipboard {
            copy_to_clipboard(&result);
            println!("Copied to clipboard.");
    ...
    if let Some(ref query) = cockpit.redis_ref {
        let result = hematite::tools::math_util::redis_ref_calc(query.trim());
        println!("{}", result.trim());
        if cockpit.clipboard {
            copy_to_clipboard(&result);
            println!("Copied to clipboard.");
    ...
    if let Some(ref query) = cockpit.web_apis {
        let result = hematite::tools::math_util::web_apis_calc(query.trim());
        println!("{}", result.trim());
        if cockpit.clipboard {
            copy_to_clipboard(&result);
            println!("Copied to clipboard.");
    ...
    if let Some(ref query) = cockpit.linux_containers {
        let result = hematite::tools::math_util::linux_containers_calc(query.trim());
        println!("{}", result.trim());
        if cockpit.clipboard {
            copy_to_clipboard(&result);
            println!("Copied to clipboard.");
    ...
    if let Some(ref query) = cockpit.ci_cd_adv {
        let result = hematite::tools::math_util::ci_cd_adv_calc(query.trim());
        println!("{}", result.trim());
        if cockpit.clipboard {
            copy_to_clipboard(&result);
            println!("Copied to clipboard.");
    ...
    if let Some(ref query) = cockpit.sql_ops {
        let result = hematite::tools::math_util::sql_ops_calc(query.trim());
        println!("{}", result.trim());
        if cockpit.clipboard {
            copy_to_clipboard(&result);
            println!("Copied to clipboard.");
    ...
    if let Some(ref query) = cockpit.ts_patterns {
        let result = hematite::tools::math_util::ts_patterns_calc(query.trim());
        println!("{}", result.trim());
        if cockpit.clipboard {
            copy_to_clipboard(&result);
            println!("Copied to clipboard.");
    ...
    if let Some(ref query) = cockpit.mobile_web {
        let result = hematite::tools::math_util::mobile_web_calc(query.trim());
        println!("{}", result.trim());
        if cockpit.clipboard {
            copy_to_clipboard(&result);
            println!("Copied to clipboard.");
    ...
    if let Some(ref query) = cockpit.ansible_ref {
        let result = hematite::tools::math_util::ansible_ref_calc(query.trim());
        println!("{}", result.trim());
        if cockpit.clipboard {
            copy_to_clipboard(&result);
            println!("Copied to clipboard.");
    ...
    if let Some(ref query) = cockpit.nginx_ref {
        let result = hematite::tools::math_util::nginx_ref_calc(query.trim());
        println!("{}", result.trim());
        if cockpit.clipboard {
            copy_to_clipboard(&result);
            println!("Copied to clipboard.");
    ...
    if let Some(ref query) = cockpit.protobuf_ref {
        let result = hematite::tools::math_util::protobuf_ref_calc(query.trim());
        println!("{}", result.trim());
        if cockpit.clipboard {
            copy_to_clipboard(&result);
            println!("Copied to clipboard.");
    ...
    if let Some(ref query) = cockpit.rust_embedded {
        let result = hematite::tools::math_util::rust_embedded_calc(query.trim());
        println!("{}", result.trim());
        if cockpit.clipboard {
            copy_to_clipboard(&result);
            println!("Copied to clipboard.");
    ...
    if let Some(ref query) = cockpit.svelte_ref {
        let result = hematite::tools::math_util::svelte_ref_calc(query.trim());
        println!("{}", result.trim());
        if cockpit.clipboard {
            copy_to_clipboard(&result);
            println!("Copied to clipboard.");
    ...
    if let Some(ref query) = cockpit.kafka_adv {
        let result = hematite::tools::math_util::kafka_adv_calc(query.trim());
        println!("{}", result.trim());
        if cockpit.clipboard {
            copy_to_clipboard(&result);
            println!("Copied to clipboard.");
    ...
    if let Some(ref query) = cockpit.deno_ref {
        let result = hematite::tools::math_util::deno_ref_calc(query.trim());
        println!("{}", result.trim());
        if cockpit.clipboard {
            copy_to_clipboard(&result);
            println!("Copied to clipboard.");
    ...
    if let Some(ref query) = cockpit.otel_ref {
        let result = hematite::tools::math_util::otel_ref_calc(query.trim());
        println!("{}", result.trim());
        if cockpit.clipboard {
            copy_to_clipboard(&result);
            println!("Copied to clipboard.");
    ...
    if let Some(ref query) = cockpit.zig_ref {
        let result = hematite::tools::math_util::zig_ref_calc(query.trim());
        println!("{}", result.trim());
        if cockpit.clipboard {
            copy_to_clipboard(&result);
            println!("Copied to clipboard.");
    ...
    if let Some(ref query) = cockpit.redis_adv {
        let result = hematite::tools::math_util::redis_adv_calc(query.trim());
        println!("{}", result.trim());
        if cockpit.clipboard {
            copy_to_clipboard(&result);
            println!("Copied to clipboard.");
    ...
    if let Some(ref query) = cockpit.valgrind_ref {
        let result = hematite::tools::math_util::valgrind_ref_calc(query.trim());
        println!("{}", result.trim());
        if cockpit.clipboard {
            copy_to_clipboard(&result);
            println!("Copied to clipboard.");
    ...
    if let Some(ref query) = cockpit.scrum_ref {
        let result = hematite::tools::math_util::scrum_ref_calc(query.trim());
        println!("{}", result.trim());
        if cockpit.clipboard {
            copy_to_clipboard(&result);
            println!("Copied to clipboard.");
    ...
    if let Some(ref query) = cockpit.powershell_adv {
        let result = hematite::tools::math_util::powershell_adv_calc(query.trim());
        println!("{}", result.trim());
        if cockpit.clipboard {
            copy_to_clipboard(&result);
            println!("Copied to clipboard.");
    ...
    if let Some(ref query) = cockpit.jvm_ref {
        let result = hematite::tools::math_util::jvm_ref_calc(query.trim());
        println!("{}", result.trim());
        if cockpit.clipboard {
            copy_to_clipboard(&result);
            println!("Copied to clipboard.");
    ...
    if let Some(ref query) = cockpit.case {
        let result = hematite::tools::math_util::case_calc(query.trim());
        println!("{}", result.trim());
        if cockpit.clipboard {
            copy_to_clipboard(&result);
            println!("Copied to clipboard.");
