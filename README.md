...
For structured workstation and network questions, prefer `inspect_host` first. It covers 76+ topics across the full SysAdmin, Network Admin, security, and developer tooling stack:
