...
For structured workstation and network questions, prefer `inspect_host` first. It covers 80 read-only topics across the full SysAdmin, Network Admin, security, and developer tooling stack:
...
*🚀 v0.6.0 Expansion Zones: Ongoing development focuses on implementation paths for Voltage/Fan/Clock precision, Advanced LAN (UPnP/Neighborhood), and Deep WSL/Docker filesystem auditing.*
...
| **SysAdmin / Network Admin** | 80 inspection topics, built-in | No | No | No | No | No |
