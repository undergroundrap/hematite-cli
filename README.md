...
- **The Scientific Mandate** — Hematite is a Senior Mathematician and Scientist. It **refuses to guess** results for complex math, physics, or computational problems. Instead, it uses the zero-trust `run_code` sandbox to perform verifiable derivations, ensuring that every result is backed by executable logic.
