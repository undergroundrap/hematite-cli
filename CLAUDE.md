...
- `SKILLS.md` / `SKILL.md`: optional workspace guidance files for project conventions, domain recipes, and repo-specific operating patterns; they are additive to the built-in workflow engine, not a replacement for `.hematite/PLAN.md` or `.hematite/TASK.md`
...
- **Per-project rule and skill injection** — ✓ Done. Hematite now natively checks for `.hematite/rules.md`, `HEMATITE.md`, `CLAUDE.md`, `SKILLS.md`, and `SKILL.md` and injects them into the system prompt as project guidance. This is additive guidance only; sovereign scaffold, `.hematite/PLAN.md`, `.hematite/TASK.md`, and resumable execution remain baked-in harness workflows. Includes a `/rules` command for viewing and editing shared guideline files directly from the TUI.
