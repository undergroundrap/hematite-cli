...
For structured workstation questions, prefer `inspect_host` first. It now covers common toolchains, PATH, network snapshots, process snapshots, desktop/downloads, listening ports, repo-doctor summaries, and arbitrary directory or disk inspections before falling back to raw shell.
